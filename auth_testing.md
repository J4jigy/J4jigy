...
```bash
# Test auth endpoint
curl -X GET "https://fuelfinance.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://fuelfinance.preview.emergentagent.com/api/dashboard/summary" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://fuelfinance.preview.emergentagent.com");
```

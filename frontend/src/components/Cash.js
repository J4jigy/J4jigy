...
import { ArrowLeft, Search, Shield, Plus } from 'lucide-react';
...
export default function Cash() {
  ...
  // Check if user has cash view permission
    ...
    return (
      <div className="min-h-screen bg-slate-900 text-white flex flex-col">
        ...
        <div className="px-3 py-2 border-b border-slate-700 flex items-center gap-2">
          ...
          <h1 className="text-base font-semibold">Cash Management</h1>
        </div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-400 mb-4">
                You don't have permission to view cash management.
              </p>
              <p className="text-sm text-slate-500">
                Contact your business owner or manager for access.
              </p>
            </CardContent>
          </Card>
        </div>

  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col max-h-screen overflow-hidden">
      ...
      <div className="flex-1 px-2 pt-0 pb-2 space-y-1 overflow-hidden">
        ...
        {/* Challan Preview Window - Shows when swiped right */}
        {showChallanPreview && (
          <div className="mt-2 bg-slate-800 border border-slate-600 rounded-lg p-3 animate-in slide-in-from-right">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-700/50 p-2 rounded text-xs">
                ...
                <div className="text-white font-semibold">{selectedCustomer || 'Not Selected'}</div>
              </div>
              
              <div className="bg-slate-700/50 p-2 rounded text-xs">
                <div className="text-slate-400">Amount</div>
                <div className="text-green-400 font-bold text-lg">₹{amount}</div>
              </div>
              
              {/* Items Preview */}
              {Object.keys(selectedItems).length > 0 && (
                <div className="bg-slate-700/50 p-2 rounded text-xs">
                  <div className="text-slate-400 mb-1">Items ({Object.keys(selectedItems).length})</div>

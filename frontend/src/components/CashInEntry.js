  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col max-h-screen overflow-hidden">
      ...
      <Dialog open={showBillModal} onOpenChange={setShowBillModal}>
        <DialogContent className="bg-slate-800 border-slate-700 w-[90vw] max-w-5xl mx-auto my-4 max-h-[90vh] overflow-y-auto flex flex-col items-center">
          <DialogHeader>
            <DialogTitle className="text-white flex items-center gap-2">
          ...
          {/* Tax Selection Box */}
          <div className="bg-slate-700/50 border border-slate-600 rounded-lg p-3 space-y-3 w-full">
          ...
          {selectedSlotForBill !== null && (
            <div id="invoice-content" className="space-y-3 bg-white p-6 rounded w-full">
              {/* GST Invoice Header */}

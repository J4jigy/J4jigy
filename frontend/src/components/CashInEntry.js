          ...
          {selectedSlotForBill !== null && (
            <div className="space-y-3 bg-white p-4 rounded">
              ...
              <div className="border-2 border-black">
                {/* Table Header */}
                <div className="bg-gray-100 px-2 py-2 grid grid-cols-12 gap-1 text-xs font-semibold text-black border-b-2 border-black">
                ...
                {parseFloat(slots[selectedSlotForBill]?.amount) > 0 ? (
                  <div className="px-2 py-2 grid grid-cols-12 gap-1 text-xs bg-white">
                ...
                <div className="border border-slate-600 p-2 bg-slate-800/50">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {!isEditingTerms ? (
                      ...
                      <div className="flex gap-1">
                        <Button onClick={saveTerms} size="sm" className="h-6 px-2 text-xs bg-green-600 hover:bg-green-700">
                          Save
                        </Button>
                        <Button onClick={cancelTermsEdit} variant="ghost" size="sm" className="h-6 px-2 text-xs">
                          Cancel
                        </Button>
                      </div>
                    )}

...
const CashInEntry = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      {/* Header */}
      <div className="bg-green-500/20 backdrop-blur-sm border-b border-green-500/30 px-4 py-3 flex items-center justify-between">
        <Button 
          variant="ghost" 
          size="sm" 
        ...
        <h1 className="text-white font-semibold text-lg">Add Cash In Entry</h1>
      ...
      <div className="flex-1 p-3 space-y-2 overflow-hidden">
        ...
        {/* Action Buttons */}
        <div className="flex gap-2">
          <Button className="flex-1 bg-sky-500 hover:bg-sky-600 h-8 text-xs">
            Save & Add New
          </Button>
          <Button className="flex-1 bg-sky-500 hover:bg-sky-600 h-8 text-xs">
            Save

...
It's completely free to try!`;
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      {!showProfileDialog && (
        <div className="fixed top-1/2 right-0 transform -translate-y-1/2 translate-x-1/2 z-50">
          ...
          <Button
            ...
            className={`w-4 h-14 rounded-md bg-slate-700/90 hover:bg-slate-600 border border-slate-600 shadow-lg flex items-center justify-center backdrop-blur-sm transition-all duration-200 ${

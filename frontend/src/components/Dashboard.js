...
import { Home, UserCircle, ShieldCheck, Users, Truck, Star, ShoppingCart, Zap, Building, Coins, Receipt, Package, PieChart, BarChart3, Gift, MessageCircle, Send, Plus, Minus, Shield, Settings, ChevronDown, CheckSquare, Share2, Copy, ArrowLeft, ScanLine, FileBarChart, Landmark, Fuel } from 'lucide-react';
...
It's completely free to try!`;
  ...
  const handleTileClick = (tile) => {
    ...
    console.log('Tile clicked:', name); // Debug log

...
import { Home, UserCircle, ShieldCheck, Users, Truck, Star, ShoppingCart, Zap, Building, Coins, Receipt, Package, PieChart, BarChart3, Gift, MessageCircle, Send, Plus, Minus, Shield, Settings, ChevronDown, CheckSquare, Share2, Copy, ArrowLeft, ScanLine, FileBarChart, Landmark, Fuel, Download, Upload, TrendingUp, ClipboardList, ArrowDownRight, ArrowUpRight, Calendar, Calculator, Edit2, X, QrCode, Smartphone, CreditCard, Wallet, FileText } from 'lucide-react';
...
It's completely free to try!`;
  ...
  const businessTiles = [
    ...
    { name: 'Challan', subtitle: 'Management', icon: ClipboardList, iconColor: 'text-cyan-400', permissions: ['reports_view'] },

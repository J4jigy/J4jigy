...
import { ArrowLeft, FileText, Calendar, Search, TrendingUp, Clock, CheckCircle, Users, Filter } from 'lucide-react';
...
export default function ReceivablesYouWillReceive() {
  ...
  // Sample receivables data with categories and status
  const allReceivables = [
    { id: 1, customer: 'Rajesh Enterprises', amount: 25000, date: '2025-09-12', dueDate: '2025-10-12', invoiceNo: 'INV-001', description: 'Fuel Sales', status: 'overdue', category: 'Sales', daysOverdue: 8 },
    { id: 2, customer: 'Sharma Transport', amount: 15000, date: '2025-09-18', dueDate: '2025-10-18', invoiceNo: 'INV-002', description: 'Diesel Supply', status: 'due-soon', category: 'Sales', daysOverdue: 0 },
    { id: 3, customer: 'Kumar Industries', amount: 45000, date: '2025-09-25', dueDate: '2025-10-25', invoiceNo: 'INV-003', description: 'Monthly Billing', status: 'current', category: 'Sales', daysOverdue: 0 },
    { id: 4, customer: 'Patel & Sons', amount: 8000, date: '2025-10-02', dueDate: '2025-11-02', invoiceNo: 'INV-004', description: 'Petrol Sales', status: 'current', category: 'Sales', daysOverdue: 0 },
    { id: 5, customer: 'Singh Motors', amount: 32000, date: '2025-10-08', dueDate: '2025-11-08', invoiceNo: 'INV-005', description: 'Fleet Services', status: 'current', category: 'Services', daysOverdue: 0 },
    { id: 6, customer: 'Gupta Trading', amount: 18000, date: '2025-09-05', dueDate: '2025-10-05', invoiceNo: 'INV-006', description: 'Lubricants', status: 'overdue', category: 'Sales', daysOverdue: 15 },
    { id: 7, customer: 'Verma Logistics', amount: 22000, date: '2025-09-22', dueDate: '2025-10-22', invoiceNo: 'INV-007', description: 'Fuel Supply', status: 'due-soon', category: 'Sales', daysOverdue: 0 },
    { id: 8, customer: 'Reddy Enterprises', amount: 12000, date: '2025-08-20', dueDate: '2025-09-20', invoiceNo: 'INV-008', description: 'Services', status: 'paid', category: 'Services', daysOverdue: 0 },
  ];

  // Calculate summary statistics
  const totalReceivable = allReceivables.filter(r => r.status !== 'paid').reduce((sum, r) => sum + r.amount, 0);
  ...
  const collectedAmount = allReceivables.filter(r => r.status === 'paid').reduce((sum, r) => sum + r.amount, 0);
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <Card className="bg-gradient-to-br from-green-600 to-green-700 border-0">
            <CardContent className="p-3">
              ...
              <p className="text-xs text-green-100 mt-1">{allReceivables.filter(r => r.status !== 'paid').length} invoices</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-600 to-orange-700 border-0">
            <CardContent className="p-3">
              ...
              <p className="text-xs text-orange-100 mt-1">{dueSoonCount} invoices</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-600 to-blue-700 border-0">
            <CardContent className="p-3">
              ...
              <p className="text-xs text-blue-100 mt-1">{allReceivables.filter(r => r.status === 'paid').length} invoices</p>
            </CardContent>
          </Card>
        </div>

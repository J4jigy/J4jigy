  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white pb-20">
      ...
      <button
        ...
        className="fixed bottom-20 right-8 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all z-50"
      >
